...
- (Done) [Conduit (RealWorld) Example App](https://github.com/CXwudi/realworld-cmp-decompose-mvikotlin-app): A frontend implementation of [Conduit](https://github.com/gothinkster/realworld) example app for practicing and learning Compose Multiplatform
- (WIP) [Nijigen Video Site](https://github.com/CXwudi/nijigen-video-site): A fullstack video site, practicing cloud-native dev
